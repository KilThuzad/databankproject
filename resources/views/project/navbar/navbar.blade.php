...
<body class="d-flex">
    <div class="sidebar d-flex flex-column vh-100" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('research_projects') ? 'active' : '' }}" href="{{ url('/research_projects') }}">
            ...
            <li class="nav-item">
                <a href="{{ url('/member-agencies') }}" class="nav-link {{ request()->is('member-agencies') ? 'active' : '' }}">
        ...
        <nav class="navbar navbar-expand-lg navbar-light topbar">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form class="d-flex ms-auto me-3 search-box" action="{{ route('global.search') }}" method="GET">
                    ...
                    <div class="dropdown user-dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li class="user-profile text-center p-3">
                                ...
                                <small class="text-white-80 text-uppercase">{{ session('role') }}</small>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{ route('profile.show') }}"><ion-icon name="person-outline" class="me-2"></ion-icon>Profile</a></li>
                            <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><ion-icon name="settings-outline" class="me-2"></ion-icon>Settings</a></li>
                            <li><a class="dropdown-item" href="{{ url('/activities') }}"><ion-icon name="notifications-outline" class="me-2"></ion-icon>Notifications</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
