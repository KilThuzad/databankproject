...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/reviewer/navbar.css') }}">
...
<body class="d-flex">
    <div class="sidebar d-flex flex-column vh-100" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a class="nav-link {{ request()->is('reviewerDashboard') ? 'active' : '' }}" href="{{ url('/reviewerDashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('reviewerResearches') ? 'active' : '' }}" href="{{ url('/reviewerResearches') }}">
            ...
            <li class="nav-item">
                <a href="{{ url('/reviewer-events') }}" class="nav-link {{ request()->is('reviewerevents') ? 'active' : '' }}">
                    ...
                    <div class="dropdown user-dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li class="user-profile text-center p-3">
                                ...
                                <small class="text-white-80">Reviewer Member</small>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{ route('reviewer.profile') }}"><ion-icon name="person-outline" class="me-2"></ion-icon>Profile</a></li>
                            <li><a class="dropdown-item" href="{{ route('reviewer.profile.edit') }}"><ion-icon name="settings-outline" class="me-2"></ion-icon>Settings</a></li>
                            <li><a class="dropdown-item" href="{{ route('Reviewer.notifications') }}"><ion-icon name="notifications-outline" class="me-2"></ion-icon>Notifications</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
