...
<link rel="stylesheet" href="{{ asset('css/researcher/profile.css') }}">
        ...
        <div class="col-lg-8 col-md-7">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-darkred border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('userprofile.edit') }}" class="btn btn-outline-light btn-sm mt-2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                {{-- File Input Form --}}
                <form id="updatePictureForm" action="{{ route('userprofile.updatePicture') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        {{-- Changed from type="submit" to type="button" and added data-bs-toggle for confirmation modal --}}
...
{{-- New Confirmation Modal for Profile Picture Update --}}
