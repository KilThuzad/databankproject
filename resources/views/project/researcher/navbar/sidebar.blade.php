    ...
    <div class="d-flex flex-column flex-shrink-0 p-3  text-white sidebar" style="width: 280px;">
        <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <span class="d-flex flex-column align-items-center">
                <h4 class="mb-1">EVCIEERD</h4>
                <p class="mb-0">Databank</p>
            </span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="{{ url('/userdashboard') }}" class="nav-link text-white active" aria-current="page">
            ...
            <li>
                <a href="{{ url('/userresearchproject/create') }}" class="nav-link text-white">
                    <ion-icon name="add-circle" class="me-2"></ion-icon>
                    Submit Research
                </a>
            </li>
             <li>
                <a href="{{ route('userresearchproject.index') }}" class="nav-link text-white">
            ...
            <li>
                <a href="{{ route('userevents.index') }}" class="nav-link text-white">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form class="d-flex ms-auto me-3 search-box" action="{{ route('userglobal.search') }}" method="GET">
                        <input class="form-control me-2" type="search" name="query" placeholder="Search here">
